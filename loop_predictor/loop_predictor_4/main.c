...
int main(int argc, char* argv[]) {
    ...
    uint64_t count1 = atoi(argv[1]);
    uint64_t count2 = atoi(argv[2]);
    uint64_t count3 = atoi(argv[3]);
    uint64_t count4 = atoi(argv[4]);
    ...
    __asm__ volatile (
        ...
        : "r"(count1), "r"(count2), "r"(count3), "r"(count4) // Input variables
